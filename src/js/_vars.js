...
export const pointerSvg =
  ...
  '<path fill-rule="evenodd" clip-rule="evenodd" d="M14.8418 1.15817C14.892 1.20819 14.9317 1.2676 14.9589 1.33301C14.986 1.39842 15 1.46854 15 1.53936C15 1.61018 14.986 1.6803 14.9589 1.74571C14.9317 1.81112 14.892 1.87053 14.8418 1.92055L8.38104 8.38133C8.33103 8.43147 8.27162 8.47125 8.20621 8.49839C8.1408 8.52553 8.07068 8.5395 7.99986 8.5395C7.92904 8.5395 7.85892 8.52553 7.79351 8.49839C7.7281 8.47125 7.66868 8.43147 7.61867 8.38133L1.15789 1.92055C1.0568 1.81945 1 1.68233 1 1.53936C1 1.39639 1.0568 1.25927 1.15789 1.15817C1.25899 1.05708 1.39611 1.00028 1.53908 1.00028C1.68205 1.00028 1.81917 1.05708 1.92026 1.15817L7.99986 7.23885L14.0795 1.15817C14.1295 1.10804 14.1889 1.06826 14.2543 1.04111C14.3197 1.01397 14.3898 1 14.4606 1C14.5315 1 14.6016 1.01397 14.667 1.04111C14.7324 1.06826 14.7918 1.10804 14.8418 1.15817Z" fill="#064AB1" stroke="#064AB1"/>\n' +
  '</svg>\n'
     ...
     <input class="room-order-input" type="hidden" name="order_room_id[2]" value="" />
      <h3>
        <span class="changeable-amount">1</span> номер
                бронирования     
            <button class="delete-room-btn" data-btn="delete-room" type="button">
      ...
      <ul class="guests-list">
                <li>
                  ...
                  >
                    ...
                    <div class="input-column-wrapper">
                      <label>Имя гостя<span>*</span></label>
                      <input
                        class="main-input"
                        type="text"
                        placeholder="Имя"
       ...
       <div class="rooms-list__item-controllers">
          <button
                  class="main-btn _blue-outlined"
                  type="button"
                  data-template="new-adult"
                >
                  <svg width="16" height="17" viewBox="0 0 16 17" fill="none"
                       xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M1.33333 16.4814C1.33333 16.4814 0 16.4814 0 15.1481C0 13.8148 1.33333 9.81478 8 9.81478C14.6667 9.81478 16 13.8148 16 15.1481C16 16.4814 14.6667 16.4814 14.6667 16.4814H1.33333ZM8 8.48145C9.06087 8.48145 10.0783 8.06002 10.8284 7.30987C11.5786 6.55973 12 5.54231 12 4.48145C12 3.42058 11.5786 2.40316 10.8284 1.65302C10.0783 0.902873 9.06087 0.481445 8 0.481445C6.93913 0.481445 5.92172 0.902873 5.17157 1.65302C4.42143 2.40316 4 3.42058 4 4.48145C4 5.54231 4.42143 6.55973 5.17157 7.30987C5.92172 8.06002 6.93913 8.48145 8 8.48145Z"
                      fill="#064AB1" />
                  </svg>
                  Добавить еще одного взрослого
                </button>
          <button
                  class="main-btn _blue-outlined"
                  type="button"
                  data-template="new-child"
                >
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                       xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M15.456 13.7836L13.1648 14.7134C13.0032 13.1213 12.2545 11.9425 10.8817 11.1872C10.0568 10.7328 9.16512 10.6007 8.23481 10.7323C6.4357 10.9874 4.58843 12.5443 4.57174 15.0858C4.17787 14.9723 3.7883 14.8689 3.40444 14.7468C3.05301 14.6352 2.71017 14.4974 2.35922 14.3834C2.2381 14.3439 2.20663 14.2881 2.22475 14.165C2.3411 13.3878 2.45125 12.6096 2.56283 11.8314C2.772 10.3755 2.98117 8.91984 3.19034 7.46453C3.21323 7.30527 3.24089 7.14648 3.25901 6.98769C3.29811 6.63197 3.17508 6.44171 2.83605 6.32012C2.40976 6.16896 1.98204 6.02257 1.55908 5.86379C1.28301 5.76322 1.04033 5.58789 0.858132 5.35739C0.381294 4.75514 0.590151 3.97933 1.31018 3.7142C2.24287 3.37136 3.18176 3.04663 4.11732 2.71285C4.30233 2.64704 4.48686 2.58028 4.67045 2.51019C4.9885 2.38955 5.16397 2.13587 5.15205 1.79493C5.14109 1.48547 5.11629 1.17505 5.09579 0.867009C5.07242 0.517487 5.24742 0.398754 5.56833 0.538944C6.95116 1.1431 7.67166 2.25079 7.98161 3.67749C8.16579 4.5348 8.24584 5.4112 8.22002 6.2877C8.20381 6.9114 8.43079 7.1007 9.03065 7.09355C10.6338 7.07448 12.2369 7.08687 13.84 7.08735C14.3121 7.08735 14.5076 7.24185 14.5744 7.70724C14.7889 9.15015 14.9964 10.594 15.2062 12.0374C15.2834 12.5676 15.3603 13.0979 15.437 13.6281C15.4427 13.6682 15.447 13.7092 15.456 13.7836Z"
                      fill="#064AB1" />
                  </svg>
...
export const newAdultGuest = `<li>
                  ...
                  >
                    ...
                    <div
                        class="input-column-wrapper scan-wrapper changeable-input"
                      >
                        <label>
                          Скан документа (не более 2Мб, PDF)
                        </label>
                        <div class="file-upload">
                          ...
                          >
                            <input
                              ...
                              name="adult_scan_document[1][1]"
                              accept="application/pdf"
                            />
                            Загрузить pdf-файл
                          </label>
                          <input
                            class="file-upload__input-id"
                            type="hidden"
                            value="1234"
                          />
                        </div>
...
export const newChildGuest = `<li>
                  ...
                  >
                    <div class="input-column-wrapper">
                      <label>Фамилия гостя<span>*</span></label>
                      <input
                        class="main-input"
                        type="text"
                        placeholder="Фамилия"
                    ...
                    <div class="input-column-wrapper">
                      <label>Отчество гостя<span>*</span></label>
                      <input
                        class="main-input"
                        type="text"
                        placeholder="Отчество"
